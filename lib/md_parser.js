...
const parser = function (string, relPath, callback, argvObj, queryObj, commonData) { 
  ...
  json.headFiles = getFilesHtml(json.headFiles, relPath)
  json.files = getFilesHtml(json.files, relPath)
